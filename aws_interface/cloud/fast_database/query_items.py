...
#
#     sk_condition = params.get('sk_condition', None)  # 대용으로 씀
#     sort_condition = params.get('sort_condition', sk_condition)
...
@NeedPermission(Permission.Run.FastDatabase.query_items)
def do(data, resource):
    # query_items_by_partition 와 동일기능이기 때문에 리다렉션합니다.
    import cloud.fast_database.query_items_by_partition
    return cloud.fast_database.query_items_by_partition.do(data, resource)
