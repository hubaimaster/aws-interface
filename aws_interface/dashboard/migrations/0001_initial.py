    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apply_status', models.CharField(choices=[('NO', 'Not applied'), ('FA', 'Apply failed'), ('PR', 'Applying'), ('SU', 'Applied')], default='NO', max_length=2)),
                ('app', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dashboard.App')),
            ],
        ),
